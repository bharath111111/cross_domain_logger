...
for %%C in (%CHANNELS%) do (
  ...
  if %%C==3 set "NET_NAME=FD_CAN13"
  if %%C==4 set "NET_NAME=FD_CAN14"
  if %%C==5 set "NET_NAME=FD_CAN15"
  if %%C==6 set "NET_NAME=FD_CAN17"
  if %%C==7 set "NET_NAME=FD_CAN18"
  if %%C==8 set "NET_NAME=FD_CAN20"
  if %%C==9 set "NET_NAME=FD_CAN21"
  if %%C==10 set "NET_NAME=HS_CAN1"
  if %%C==11 set "NET_NAME=HS_CAN4"
