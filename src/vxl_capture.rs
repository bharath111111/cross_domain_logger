...
fn can_network_alias(app_channel: u32) -> Option<(&'static str, &'static str)> {
    match app_channel {
        ...
        2 => Some(("vn 1670 2", "FD_CAN13")),
        3 => Some(("vn 1670 2", "FD_CAN14")),
        4 => Some(("vn 1670 2", "FD_CAN15")),
        5 => Some(("vn 1670 1", "FD_CAN17")),
        6 => Some(("vn 1670 1", "FD_CAN18")),
        7 => Some(("vn 1670 1", "FD_CAN20")),
        8 => Some(("vn 1670 1", "FD_CAN21")),
        9 => Some(("vn 1670 1", "HS_CAN1")),
        10 => Some(("vn 1670 1", "HS_CAN4")),
        _ => None,
    }
}
